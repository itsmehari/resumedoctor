...
const CAPABILITIES = [
  ...
  },
  {
    ...
    body: "On Basic and above (signed in), run a fast keyword match from a pasted JD — no AI charge. AI tailoring for deeper edits shares your daily AI pool; see pricing for limits.",
  ...
  },
  {
    ...
    body: "TXT is available on Basic where shown. Portal-ready PDF and Word for resumes may use Pro or a resume pack; cover letter Word matches resume Word (Pro). Details are on pricing.",
    href: "/pricing",
