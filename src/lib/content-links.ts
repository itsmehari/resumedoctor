...
const BLOG_TO_BLOG: Record<string, string[]> = {
  ...
  "ats-friendly-resume-complete-guide": ["skills-section-guide", "how-to-tailor-resume-for-job-description", "how-to-write-professional-summary"],
  ...
  "handling-career-gaps-on-resume": ["how-to-write-professional-summary", "resume-formats-india-guide"],
  "resume-formats-india-guide": ["how-to-write-cv-for-freshers", "ats-friendly-resume-complete-guide", "resume-length-one-page-or-two"],
  ...
  "resume-checklist-before-you-apply": ["how-to-tailor-resume-for-job-description", "resume-length-one-page-or-two", "ats-friendly-resume-complete-guide"],
  "how-to-tailor-resume-for-job-description": ["resume-checklist-before-you-apply", "ats-friendly-resume-complete-guide", "skills-section-guide"],
};

/** Example slug → blog slugs (2–4 per example) */
const EXAMPLE_TO_BLOG: Record<string, string[]> = {
  "software-engineer-resume": ["ats-friendly-resume-complete-guide", "skills-section-guide", "how-to-write-professional-summary", "naukri-linkedin-profile-tips"],
  "fresher-resume-example": ["how-to-write-cv-for-freshers", "resume-formats-india-guide", "resume-length-one-page-or-two"],
  "data-analyst-resume": ["ats-friendly-resume-complete-guide", "skills-section-guide", "how-to-write-professional-summary"],
  "marketing-manager-resume": ["how-to-write-professional-summary", "cover-letter-examples-india", "naukri-linkedin-profile-tips"],
  ...
  "sales-executive-resume": ["how-to-write-professional-summary", "naukri-linkedin-profile-tips", "resume-length-one-page-or-two"],
